  ...
  return (
    <div className="w-full px-5 sm:px-11 md:px-20 lg:px-32 xl:px-52 flex flex-col gap-4 justify-center md:justify-between md:flex-row pb-20 bg-secondary">
        <div className='text-center md:text-left text-lg'>
            <p>Hi, my name is</p>
          <h2 className="mt-3 mb-7 text-6xl md:text-5xl xl:text-7xl font-bricolage font-black">
            FARHAN AJI PRATAMA
          </h2>
          <p>
            I build website as <b>frontend developer</b>,<br/>
        ...
        <img src={PROFILE} alt="profile image" className='mx-auto md:right-0 w-3/4 md:w-2/4 lg:h-1/4 xl:w-1/4 bg-white rounded-full' />
    </div>
  )
}
