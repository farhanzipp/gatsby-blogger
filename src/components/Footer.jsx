  ...
  return (
    <footer className="bg-white dark:bg-gray-900 shadow-md">
      ...
      <div className="md:grid grid-cols-2 items-center">
        ...
        <div className="flex w-full py-3 gap-3 justify-center">
          <a href="https://www.facebook.com/" className="h-12 text-gray-500 hover:text-gray-900 dark:hover:text-white" aria-label={`visit ${title} facebook page`}>
            <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
              <path d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" />
            </svg>
            <span className="sr-only">Facebook page</span>
          </a>
          <a href="https://twitter.com/?lang=en" className="h-12 text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank" rel="noopener noreferrer" aria-label={`visit ${title} twitter page`}>
          ...
          <a href="https://github.com/farhanzipp" className="h-12 text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank" rel="noopener noreferrer" aria-label={`visit ${title} github page`}>
          ...
          <a href="https://www.instagram.com/farhanzip/" className="h-12 text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank" rel="noopener noreferrer" aria-label={`visit ${title} instagram page`}>
          ...
          <a href="https://www.youtube.com/" className="h-12 text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank" rel="noopener noreferrer" aria-label={`visit ${title} youtube page`}>
